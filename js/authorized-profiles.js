            ...
            const sampleUsers = [
                {
                    ...
                    email: 'maria.gonzalez@ejemplo.slepiquique.cl',
                    password: 'maria123',
                    nombre: 'María',
                    apellidoPaterno: 'González',
                    apellidoMaterno: 'Silva',
                    nombreCompleto: 'María González Silva',
                    establecimiento: 'Liceo Técnico Iquique',
                    cargo: 'Profesora de Matemáticas',
                    status: 'pendiente',
                    registrationDate: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), // 2 días atrás
